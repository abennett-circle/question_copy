...
class Questionnaire_Filler(object):
    ...
    def _match_questions_to_reference(self):
        ...
        QUESTIONNAIRE_MATCHING_PROMPT = ("You are QuestionnaireMatcher. Given a new question + answered candidates, return MATCH if exactly same intent, "
                                              ...
                                              "require explicit subject match. 4) If similarity/conf<70, NO_MATCH else MATCH. Examples MATCH: \"Do you have a cat?\"↔"
    ...
    def generate_combined_questionnaire(self, output_file_name="combined_questionnaire.csv"):
        ...
        for question in unanswered_questions:
            ...
            question_id = unanswered_questions[question].get_question_id() + 1
